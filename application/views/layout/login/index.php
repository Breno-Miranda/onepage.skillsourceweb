...
<html lang="pt">
  <head>
    ...
    <title>skillsourceweb - login</title>
...
<div class="container">
    <div class="omb_login">
    	<h3 class="omb_authTitle">Login  <a href="#">Cadastre-se</a></h3>
		...
		<div class="row omb_row-sm-offset-3">
			<div class="col-xs-12 col-sm-6">	
			    <form class="omb_loginForm" action="<?= base_url('login/logar')?>" autocomplete="off" method="POST">
